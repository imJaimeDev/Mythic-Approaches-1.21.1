...
public class RightClickRecipeBuilder extends SimpleRecipeBuilder {
    ...
    public RightClickRecipeBuilder(ItemStack result, BlockState inputState, Ingredient inputItem) {
        super(result);
